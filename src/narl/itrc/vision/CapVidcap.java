...
public class CapVidcap extends Capture {
	...
	public native void setFrameSize(int ww, int hh);
	public native void setProperty(int ctrl, double val);
	public native double getProperty(int ctrl);
	...
	protected void afterSetup(){
		if(frameSize[0]>0 && frameSize[1]>0){
			...
			setProperty(11, 0.2);//CAP_PROP_CONTRAST=0.1255
			setProperty(12, 0.1);//CAP_PROP_SATURATION=0.1255
