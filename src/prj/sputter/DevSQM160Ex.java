...
public class DevSQM160Ex extends DevTTY {

	public DevSQM160Ex() {
		TAG = "SQM-160Ex";
		readTimeout = 500;
	}
	public DevSQM160Ex(String path_name) {
		this();
	...
	public static Pane genCtrlPanel(final DevSQM160Ex dev) {
	...
	public static Pane genPanel(final DevSQM160Ex dev) {
